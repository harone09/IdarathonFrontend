...
export class AddPhaseComponent implements OnInit {
  ...
  constructor(public router: Router, private projetServ:ProjetServiceService,public dialogRef: MatDialogRef<AddPhaseComponent>
 ...
 onValid():void{
   ...
   submitAddProject(p): void {
     this.projetServ.createPhase(this.data.idProjet,p).subscribe(c => {
...
export class AddPhaseModel {
  ...
  constructor(public name:string,public description:string,public dateDebut:Date,public dateFin:Date,public pourcentage:number,public idProjet:number) {
  }
}
